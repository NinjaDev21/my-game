<?php
    /*
    Plugin Name: CTL Arcade - 3 Cards Monte
    Plugin URI: http://www.codethislab.com/
    Description: 3 Cards Monte for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcade3CardsMonte {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-3-cards-monte";
        private $_szPluginName              = "3 Cards Monte";
        private $_szAspectRatio             = "15:6";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "cards, casino game, find the lady, gambling, gambling game, html5 casino game, html5 gambling, poker, sweepstakes, three card";
    ...
    $g_oCTLArcade3CardsMonte =  new CTLArcade3CardsMonte();